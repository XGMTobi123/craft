...
**Synthesise** an item, giving random Synthesised implicits. Cannot be used on Unique, Influenced, Synthesised or Fractured items (81)

**Reforge** a **Rare** item with new random modifiers, including a **Critical** modifier. **Critical** modifiers are more common (82)
**Reforge** a **Rare** item with new random modifiers, including a **Critical** modifier. **Critical** modifiers are more common (82)


**Upgrade** a **Magic item** to a Rare item, adding **two** random **high-tier** modifiers (83)
 ...
 **Augment** an item with a new **Lightning** modifier (83)
 ...
 **Remove** a random **Caster** modifier from an item (82)
 Improves the **Quality** of a **Gem** by at least 10%. The maximum quality is 20% (82)
