...
**Change** a **Gem** into another Gem, carrying over experience and quality if possible (83)
...
**Enchant** a **Weapon**. Quality does not increase its Physical Damage, grants 1% increased Area of Effect per 4% Quality (81)
...
**Reforge** a Rare item with Lucky modifier values, keeping all **Prefixes** (83)
...
**Reforge** a Rare item, keeping all **Prefixes** (82)
...
**Remove** a random **Life** modifier from an item (82),
...
**Remove** a random **non-Defence** modifier from an item and **add** a new **Defence** modifier (81),
